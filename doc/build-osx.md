...
2.  Build Prasicoin Core:
    ...
    Configure and build the headless Prasicoin Core binaries as well as the GUI (if Qt is found).
...
You can monitor the download process by looking at the debug.log file:
    ...
    tail -f $HOME/Library/Application\ Support/Prasicoin/debug.log
