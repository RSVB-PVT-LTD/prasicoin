# Support for Output Descriptors in Prasicoin Core

Since Prasicoin Core v0.17, there is support for Output Descriptors. This is a
...
on Prasicoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Prasicoin Core wallets, a convenience function `combo` is
