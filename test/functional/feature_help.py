...
"""Verify that starting prasicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start prasicoin with -h for help text")
        ...
        self.log.info("Start prasicoin with -version for version information")
        ...
        self.log.info("Start prasicoind with -fakearg to make sure it does not start")
