...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " prasicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  prasicoin-tx [options] <hex-tx> [commands]  Update hex-encoded prasicoin transaction\n" +
            "or:     prasicoin-tx [options] -create [commands]   Create hex-encoded prasicoin transaction\n" +
            "\n";
